...
describe('Custom HTTP Exception Classes', () => {
  it('should create InternalServerErrorException', () => {
    ...
    expect(exception.message).to.equal('Oops! We encountered an error processing this request.');
  });
